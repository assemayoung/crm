...
<body id="page-top">
    <div id="wrapper">
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0 my-2">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item"><a class="nav-link active" href="restaurants.php"><i class="fas fa-store-alt"></i><span>Мейрамханалар</span></a></li>
                ...
                <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                        <form class="form-inline d-none d-sm-inline-block mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                            <div class="input-group"><input class="bg-light form-control border-0 small" type="text" placeholder="Шығу">
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="row card-body">
                    <h2 class="mb-4 mt-2">"Primer" Мейрамханасы</h2>
                    <div class="col-lg-4">
                        <div class="card-body bg-light rounded-3 border-secondary pb-5">
                            <p class="text-primary mb-1">Резерв кітабы</p>
                            <h5 class="fw-bold text-dark mb-1">Гоголя, 51</h5>
                            <p>Алматы</p>
                        </div>
                    </div>
                    <div class="col-lg-4 text-center">
                        <button class="card-body rounded-3 border border-secondary pb-4 w-100 bg">
                            <div  href="#" class="rounded-circle border border-secondary m-auto d-flex align-items-center justify-content-center" style="width: 80px;height: 80px;">
                                <p class="mb-0 text-secondary" style="font-size: 50px">+</p>
                            </div>
                            
                            <h5 class="text-secondary mt-2">Жаңа адрес</h5>
                        </button>
                    </div>
                </div>
            </div>
