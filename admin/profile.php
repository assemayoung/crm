        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0  my-2"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="profile.php"><i class="fas fa-user"></i><span>Профиль</span></a></li>
                        ...
                        <ul class="nav navbar-nav flex-nowrap ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow mx-1">
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false" href="#"><i class="fas fa-envelope fa-fw"></i><span class="badge badge-danger badge-counter">7</span></a>
                                    <div class="dropdown-menu dropdown-menu-right dropdown-list dropdown-menu-right animated--grow-in">
                                        <h6 class="dropdown-header">alerts center</h6><a class="d-flex align-items-center dropdown-item" href="#">
                                            <div class="dropdown-list-image mr-3"><img class="rounded-circle" src="'.$_SESSION['user']['avatar'].'" alt="">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row mb-3">
                        <div class="col-lg-4 col-md-12">
                            <div class="card mb-3">
                                <div class="card-body text-center shadow"><img class="rounded-circle mb-3 mt-4" src="<?php echo $_SESSION['user']['avatar'];?>" width="160" height="160" alt="">
                                    <h5 class="font-weight-bold text-secondary">
                                        <?php echo $_SESSION['user']['position'];?>
                                    </h5>
                                    <a href="vender/logout.php" class="text-danger">Шығу</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-8 col-md-12">
                            <div class="card shadow mb-3">
                                <div class="card-header py-3">
                                    <h6 class="text-primary m-0 font-weight-bold">Сіздің деректеріңіз</h6>
                                </div>
                                <div class="card-body">
                                    <form>
                                        <div class="form-row">
                                            <div class="col-lg-6 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="login" placeholder="<?php echo $_SESSION['user']['login'];?>" name="login">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="col-lg-6 col-md-12">
                                                <div class="form-group"><label><strong>Email</strong></label><input class="form-control" type="email" placeholder="<?php 
                                            echo $_SESSION['user']['email'];
                                        ?>" name="email"></div>
                                            </div>
                                            <div class="col-lg-6 col-md-12">
                                                <div class="form-group"><label><strong>Телефон</strong></label><input class="form-control" type="text" placeholder="<?php echo $_SESSION['user']['telephone'];?>" name="telephone"></div>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="col-lg-6 col-md-12">
                                                <div class="form-group"><label><strong>Аты</strong></label><input class="form-control" type="text" placeholder="<?php echo $_SESSION['user']['FirstName'];?>" name="firstname"></div>
                                            </div>
                                            <div class="col-lg-6 col-md-12">
                                                <div class="form-group"><label><strong>Жөні</strong></label><input class="form-control" type="text" placeholder="<?php echo $_SESSION['user']['LastName'];?>" name="lastname"></div>
                                            </div>
                                        </div>
                                        <div class="form-row mt-1 align-items-center">
                                            <div class="col-lg-6 col-md-12">
                                                <div class="form-group">
                                                    <label><strong>Туған күні</strong></label>
                                                    <input class="form-control form-control-user" type="date" value="<?php echo $_SESSION['user']['Birthday'];?>" name="BirthDate" pattern="[0-9]{2}\.[0-9]{2}\.[0-9]{4}"></div>
                                            </div>
                                        </div>
                                             
                                        <div class="form-row mt-3">
                                            <div class="col-lg-4">
                                                <button class="btn btn-primary btn-sm" type="submit">Сақтау</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
